...
int main(int argc, char **argv)
{
	...
	while (1)
	{
		...
		if (i == 1)
		{
			yyout = fopen("C:\\temp\\test1_205613516_lex.txt", "w");
			output = fopen("C:\\temp\\test1_205613516_syn.txt", "w");
		}
		else if (i == 2)
		{
			yyout = fopen("C:\\temp\\test2_205613516_lex.txt", "w");
			output = fopen("C:\\temp\\test2_205613516_syn.txt", "w");
		}
